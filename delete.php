<?php 
mysql_connect("localhost","bdappras_tinkle","qwaszx");
mysql_select_db("bdappras_tinkle");

$rowquery=mysql_query("select * from user where email='".$_REQUEST['email']."'");
...
$headers .= "From:admin@bdappmaniac.co.in\n"; // Who the email is from 
